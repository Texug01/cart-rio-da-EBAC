...
#include <locale.h> //biblioteca de alocaçâo de texto por região 
...
int registro() //função responsavel por cadastrar os usuários no sistema
{
	...
	printf("Digite o CPF a ser cadastrado: "); //ccoletando informação do usuário
